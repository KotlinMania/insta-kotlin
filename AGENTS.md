...
This file is the quick-reference operating contract for insta-kotlin. The longer
...
insta-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`insta`](https://crates.io/crates/insta). Upstream Rust is the behavioral oracle while the
