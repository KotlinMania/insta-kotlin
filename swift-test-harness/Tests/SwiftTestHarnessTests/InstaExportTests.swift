...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Insta.swiftmodule/`
...
//      `import Insta` above would fail at compile time.
//
//   2. The static archive `libInsta.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Insta" }` and
//      `flattenPackage = "io.github.kotlinmania.insta"` configuration in
...
final class InstaExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "Insta swift module imported cleanly")
    }
}
