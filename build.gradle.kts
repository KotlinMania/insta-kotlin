...
kotlin {
    ...
    swiftExport {
        moduleName = "Insta"
        flattenPackage = "io.github.kotlinmania.insta"
    }

    android {
        namespace = "io.github.kotlinmania.insta"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "insta-kotlin", version.toString())

    pom {
        name.set("insta-kotlin")
        description.set("Kotlin Multiplatform port of mitsuhiko/insta - A snapshot testing library for Rust")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/insta-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/insta-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/insta-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/insta-kotlin.git")
        }
    }
}
...
tasks.register<JavaExec>("codeqlCompileJvm") {
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            val sentinelFile = sentinelDir.get().asFile.resolve("io/github/kotlinmania/insta/codeql/CodeqlEmptySource.kt")
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.insta.codeql
